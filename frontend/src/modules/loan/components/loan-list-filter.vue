<template>
  ...
  >
    <el-row>
      ...
      <el-col style="margin-bottom: -0.41px;" :lg="12" :md="16" :sm="24">
        <el-form-item :label="fields.duoDataRange.label" :prop="fields.duoDataRange.name">
          <el-date-picker type="datetimerange" v-model="model[fields.duoDataRange.name]"></el-date-picker>
        </el-form-item>
      </el-col>
